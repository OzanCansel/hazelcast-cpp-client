...
#define ASSERT_EQ_EVENTUALLY_WITH_TIMEOUT(expected, actual, timeoutSeconds)    \
    ASSERT_EQ_EVENTUALLY_WITH_TIMEOUT_MSG(                                     \
      "", (expected), (actual), timeoutSeconds)
...
#define WAIT_EQ_EVENTUALLY(expected, expression)                               \
    WAIT_TRUE_EVENTUALLY((expected) == (expression))
#define WAIT_NE_EVENTUALLY(expected, expression)                               \
    WAIT_NE_EVENTUALLY((expected) != (expression))
...
#define assertSizeEventuallyWithTimeout(                                       \
  expectedSize, container, timeoutSeconds)                                     \
    do {                                                                       \
        ASSERT_EQ_EVENTUALLY_WITH_TIMEOUT_MSG(                                 \
