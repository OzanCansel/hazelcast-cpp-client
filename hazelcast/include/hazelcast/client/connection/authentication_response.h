...
class authentication_response
{
    ...
    static constexpr int AUTHENTICATION_CUSTOM_CODEC_RESPONSE_MESSAGE_TYPE              = 513;
    static constexpr int EXPERIMENTAL_AUTHENTICATION_CODEC_RESPONSE_MESSAGE_TYPE        = 16580865;
    static constexpr int EXPERIMENTAL_AUTHENTICATION_CUSTOM_CODEC_RESPONSE_MESSAGE_TYPE = 16581121;
...
private:
    ...
    static authentication_response from_authentication_codec(protocol::ClientMessage response);
    static authentication_response from_authentication_custom_codec(protocol::ClientMessage response);
    static authentication_response from_experimental_authentication_codec(protocol::ClientMessage response);
    static authentication_response from_experimental_authentication_custom_codec(protocol::ClientMessage response);
    static authentication_response decode(protocol::ClientMessage response, bool with_tpc_ports);
