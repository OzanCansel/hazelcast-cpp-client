...
DEFINE_EXCEPTION_CLASS(illegal_access,
                       protocol::ILLEGAL_ACCESS_EXCEPTION,
                       false);

DEFINE_EXCEPTION_CLASS(illegal_access_error,
                       protocol::ILLEGAL_ACCESS_ERROR,
                       false);
...
DEFINE_EXCEPTION_CLASS(unsupported_callback,
                       protocol::UNSUPPORTED_CALLBACK,
                       false);
DEFINE_EXCEPTION_CLASS(assertion_error, protocol::ASSERTION_ERROR, false);
DEFINE_EXCEPTION_CLASS(out_of_memory_error,
                       protocol::OUT_OF_MEMORY_ERROR,
                       false);
DEFINE_EXCEPTION_CLASS(stack_overflow_error,
                       protocol::STACK_OVERFLOW_ERROR,
                       false);
DEFINE_EXCEPTION_CLASS(native_out_of_memory_error,
                       protocol::NATIVE_OUT_OF_MEMORY_ERROR,
                       false);
// ---------  Non-runtime ends here -------------------------------------------/

// ---------  runtime starts here -------------------------------------------/
DEFINE_EXCEPTION_CLASS(array_index_out_of_bounds,
                       protocol::INDEX_OUT_OF_BOUNDS,
                       true);
...
DEFINE_EXCEPTION_CLASS(concurrent_modification,
                       protocol::CONCURRENT_MODIFICATION,
                       true);
DEFINE_EXCEPTION_CLASS(config_mismatch, protocol::CONFIG_MISMATCH, true);
DEFINE_EXCEPTION_CLASS(distributed_object_destroyed,
                       protocol::DISTRIBUTED_OBJECT_DESTROYED,
                       true);
...
DEFINE_EXCEPTION_CLASS(hazelcast_serialization,
                       protocol::HAZELCAST_SERIALIZATION,
                       true);
DEFINE_EXCEPTION_CLASS(illegal_argument, protocol::ILLEGAL_ARGUMENT, true);
DEFINE_EXCEPTION_CLASS(illegal_monitor_state,
                       protocol::ILLEGAL_MONITOR_STATE,
                       true);
DEFINE_EXCEPTION_CLASS(illegal_state, protocol::ILLEGAL_STATE, true);
DEFINE_EXCEPTION_CLASS(illegal_thread_state,
                       protocol::ILLEGAL_THREAD_STATE,
                       true);
DEFINE_EXCEPTION_CLASS(index_out_of_bounds,
                       protocol::INDEX_OUT_OF_BOUNDS,
                       true);
DEFINE_EXCEPTION_CLASS(invalid_address, protocol::INVALID_ADDRESS, true);
DEFINE_EXCEPTION_CLASS(invalid_configuration,
                       protocol::INVALID_CONFIGURATION,
                       true);
DEFINE_EXCEPTION_CLASS(negative_array_size,
                       protocol::NEGATIVE_ARRAY_SIZE,
                       true);
...
DEFINE_EXCEPTION_CLASS(query_result_size_exceeded,
                       ...
                       true);
DEFINE_EXCEPTION_CLASS(split_brain_protection,
                       protocol::SPLIT_BRAIN_PROTECTION,
                       true);
...
DEFINE_EXCEPTION_CLASS(response_already_sent,
                       protocol::RESPONSE_ALREADY_SENT,
                       true);
DEFINE_EXCEPTION_CLASS(runtime, protocol::RUNTIME, true);
DEFINE_EXCEPTION_CLASS(SecurityException, protocol::SECURITY, true);
/**
 * Raised at Ringbuffer::readOne if the provided sequence is smaller then
 * Ringbuffer::headSequence() is passed.
 */
DEFINE_EXCEPTION_CLASS(stale_sequence, protocol::STALE_SEQUENCE, true);
DEFINE_EXCEPTION_CLASS(target_disconnected,
                       protocol::TARGET_DISCONNECTED,
                       true);
...
DEFINE_EXCEPTION_CLASS(transaction_not_active,
                       protocol::TRANSACTION_NOT_ACTIVE,
                       true);
DEFINE_EXCEPTION_CLASS(transaction_timed_out,
                       protocol::TRANSACTION_TIMED_OUT,
                       true);
DEFINE_EXCEPTION_CLASS(unsupported_operation,
                       protocol::UNSUPPORTED_OPERATION,
                       true);
DEFINE_EXCEPTION_CLASS(access_control, protocol::ACCESS_CONTROL, true);
DEFINE_EXCEPTION_CLASS(no_data_member_in_cluster,
                       protocol::NO_DATA_MEMBER,
                       true);
DEFINE_EXCEPTION_CLASS(replicated_map_cant_be_created_on_lite_member,
                       protocol::REPLICATED_MAP_CANT_BE_CREATED,
                       true);
DEFINE_EXCEPTION_CLASS(max_message_size_exceeded,
                       protocol::MAX_MESSAGE_SIZE_EXCEEDED,
                       true);
DEFINE_EXCEPTION_CLASS(wan_replication_queue_full,
                       protocol::WAN_REPLICATION_QUEUE_FULL,
                       true);
...
DEFINE_EXCEPTION_CLASS(mutation_disallowed,
                       protocol::MUTATION_DISALLOWED_EXCEPTION,
                       true);

DEFINE_EXCEPTION_CLASS(session_expired,
                       protocol::SESSION_EXPIRED_EXCEPTION,
                       true);

DEFINE_EXCEPTION_CLASS(wait_key_cancelled,
                       protocol::WAIT_KEY_CANCELLED_EXCEPTION,
                       true);
...
DEFINE_EXCEPTION_CLASS(lock_ownership_lost,
                       protocol::LOCK_OWNERSHIP_LOST_EXCEPTION,
                       true);

DEFINE_EXCEPTION_CLASS(cp_group_destroyed,
                       protocol::CP_GROUP_DESTROYED_EXCEPTION,
                       true);

DEFINE_EXCEPTION_CLASS(cannot_replicate,
                       protocol::CANNOT_REPLICATE_EXCEPTION,
                       true);

DEFINE_EXCEPTION_CLASS(leader_demoted,
                       protocol::LEADER_DEMOTED_EXCEPTION,
                       true);

DEFINE_EXCEPTION_CLASS(stale_append_request,
                       protocol::STALE_APPEND_REQUEST_EXCEPTION,
                       true);

DEFINE_EXCEPTION_CLASS(not_leader, protocol::NOT_LEADER_EXCEPTION, true);

DEFINE_EXCEPTION_CLASS(version_mismatch,
                       protocol::VERSION_MISMATCH_EXCEPTION,
                       true);

class HAZELCAST_API retryable_hazelcast : public hazelcast_
{
public:
    retryable_hazelcast(std::string error_name,
                        int32_t error_code,
                        std::string source,
                        std::string message,
                        std::string details,
    ...
    explicit retryable_hazelcast(std::string source = "",
                                 std::string message = "",
                                 std::string details = "",
                                 std::exception_ptr cause = nullptr);
};
...
DEFINE_RETRYABLE_EXCEPTION_CLASS(caller_not_member,
                                 protocol::CALLER_NOT_MEMBER);
DEFINE_RETRYABLE_EXCEPTION_CLASS(partition_migrating,
                                 protocol::PARTITION_MIGRATING);
DEFINE_RETRYABLE_EXCEPTION_CLASS(retryable_io, protocol::RETRYABLE_IO);
DEFINE_RETRYABLE_EXCEPTION_CLASS(target_not_member,
                                 protocol::TARGET_NOT_MEMBER);
...
{
public:
    explicit invocation_might_contain_compact_data(const spi::impl::ClientInvocation& invocation);
};
...
DEFINE_EXCEPTION_CLASS(hazelcast_client_offline,
                       protocol::HAZELCAST_CLIENT_OFFLINE,
                       true);
